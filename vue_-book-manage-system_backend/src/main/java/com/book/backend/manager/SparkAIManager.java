...
public class SparkAIManager extends WebSocketListener {
    ...
    public static final String appid = "e46e7b04";
    // todo 替换成你自己的 apiSecret 图书管理系统 1.1 版本
    public static final String apiSecret = "YTlkYWUwZjFiMjdjMzc5NmVjOGRlMTk2";
    // todo 替换成你自己的 apiKey 图书管理系统 1.1 版本
    public static final String apiKey = "a57b95d9453df2b273f8bc0d8ad9e9ab";
