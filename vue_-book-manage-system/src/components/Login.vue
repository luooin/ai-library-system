...
<!--    粒子插件特效-->
    ...
    <div class="footer">
      <div style="display: flex; justify-content: space-between;">
        <span style="font-weight: bold;color:wheat;"><i class="iconfont icon-haoyou " @click="goUser"></i>系统管理员切换</span>
        <span style="font-weight: bold;color:wheat;"><i class="iconfont icon-guanliyuan" @click="goManage"></i>图书管理员切换</span>
      </div>
    </div>
  </div>
</template>
